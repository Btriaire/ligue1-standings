...
const STADIUM_PHOTO_URLS: Record<number, string> = {
  ...
  // ── Ligue 2 ──
  531: "https://upload.wikimedia.org/wikipedia/fr/thumb/a/a2/Fa%C3%A7ade_du_stade_de_l%27Aube.jpeg/1200px-Fa%C3%A7ade_du_stade_de_l%27Aube.jpeg",
  ...
  535:   "https://upload.wikimedia.org/wikipedia/commons/thumb/1/16/MMArena_Le_Mans.jpg/1200px-MMArena_Le_Mans.jpg",
...
const PERSON_PHOTOS: Record<string, string> = {
  ...
  // ── Ligue 1 2026-27 (nouveaux coaches) ──
  "filipe luis":           "https://upload.wikimedia.org/wikipedia/commons/thumb/1/18/Filipe_Lu%C3%ADs_2024.jpg/480px-Filipe_Lu%C3%ADs_2024.jpg",
  "davide ancelotti":      "https://upload.wikimedia.org/wikipedia/commons/thumb/0/0f/Davide_Ancelotti_2024.jpg/480px-Davide_Ancelotti_2024.jpg",
  "dino toppmoller":       "https://upload.wikimedia.org/wikipedia/commons/thumb/d/d4/Dino_Toppm%C3%B6ller.jpg/480px-Dino_Toppm%C3%B6ller.jpg",
  "dino toppmöller":       "https://upload.wikimedia.org/wikipedia/commons/thumb/d/d4/Dino_Toppm%C3%B6ller.jpg/480px-Dino_Toppm%C3%B6ller.jpg",
  "hugo oliveira":         "https://upload.wikimedia.org/wikipedia/commons/thumb/8/83/Hugo_Oliveira_2024.jpg/480px-Hugo_Oliveira_2024.jpg",
  "jens berthel askou":   "https://upload.wikimedia.org/wikipedia/commons/thumb/3/3b/Jens_Berthel_Askou_2024.jpg/480px-Jens_Berthel_Askou_2024.jpg",
  "julien lachuer":        "https://upload.wikimedia.org/wikipedia/commons/thumb/5/5c/Julien_Lachuer_2024.jpg/480px-Julien_Lachuer_2024.jpg",
  "stephane gilli":        "https://upload.wikimedia.org/wikipedia/commons/thumb/e/e6/St%C3%A9phane_Gilli_2024.jpg/480px-St%C3%A9phane_Gilli_2024.jpg",
  "stéphane gilli":        "https://upload.wikimedia.org/wikipedia/commons/thumb/e/e6/St%C3%A9phane_Gilli_2024.jpg/480px-St%C3%A9phane_Gilli_2024.jpg",
  "will still":            "https://upload.wikimedia.org/wikipedia/commons/thumb/0/0e/Will_Still_2024.jpg/480px-Will_Still_2024.jpg",
  "liam rosenior":         "https://upload.wikimedia.org/wikipedia/commons/thumb/8/8e/Liam_Rosenior_2024.jpg/480px-Liam_Rosenior_2024.jpg",
...
export const CLUB_PROFILES_L1: Record<number, ClubProfile> = {
  ...
  548: {
    ...
    directeurSportif: "Thiago Scuro", entraineur: "Filipe Luis",
  ...
  516: {
    ...
    president: "Stéphane Richard", presidentDepuis: 2026,
    actionnaire: "Frank McCourt (McCourt Global)",
    directeurSportif: "Mehdi Benatia", entraineur: "Bruno Genesio",
  ...
  521: {
    ...
    directeurSportif: "Marc Ingla", entraineur: "Davide Ancelotti",
  ...
  522: {
    ...
    directeurSportif: "Florent Ghisolfi", entraineur: "Olivier Pantaloni",
  ...
  546: {
    ...
    directeurSportif: "Diego Lopez", entraineur: "Dino Toppmöller",
  ...
  576: {
    ...
    directeurSportif: "Andrey Santos", entraineur: "Hugo Oliveira",
  ...
  511: {
    ...
    directeurSportif: "Jean-Baptiste Léger", entraineur: "Jens Berthel Askou",
  ...
  512: {
    ...
    directeurSportif: "Grégory Lorenzi", entraineur: "Julien Lachuer",
  ...
  532: {
    ...
    directeurSportif: "Olivier Pickeu", entraineur: "Stéphane Gilli",
  ...
  519: {
    ...
    directeurSportif: "Najim Slaoui", entraineur: "Will Still",
  ...
  543: {
    id: 543, name: "FC Nantes", shortName: "Nantes", league: "L2",
  ...
  545: {
    id: 545, name: "FC Metz", shortName: "Metz", league: "L2",
  ...
  531: {
    id: 531, name: "ES Troyes AC", shortName: "Troyes", league: "L1",
    ...
    president: "Edwin Pindi", presidentDepuis: 2024,
    ...
    ca: "~30 M€", employes: "~60", dette: "—", billetterie: "~3,5 M€", droitsTv: "~28 M€",
    equipementier: "Macron", sponsorMaillot: "Champagne Region",
    palmares: ["2× Champion L2 (2015, 2021)", "Promu L1 (2026)"],
    sources: [{ label: "DNCG 2023", url: "https://www.lnfp.fr/dncg" }],
  },
  535: {
    id: 535, name: "Le Mans FC", shortName: "Le Mans", league: "L1",
    ...
    directeurSportif: "Adrien Tameze", entraineur: "Patrick Videira",
    forme: "SASP", siege: "MMArena, 72100 Le Mans",
    ca: "~20 M€", employes: "~55", dette: "—", billetterie: "~2 M€", droitsTv: "~28 M€",
    equipementier: "Kappa", sponsorMaillot: "MMA",
    palmares: ["Promu L2 (2024)", "Promu L1 (2026)"],
    sources: [{ label: "DNCG 2023", url: "https://www.lnfp.fr/dncg" }],
  },
  525: {
    ...
    directeurSportif: "Pierre-Yves Hamel", entraineur: "Alexandre Dujeux",
  ...
  1045: {
    ...
    directeurSportif: "François Ferracci", entraineur: "Liam Rosenior",
...
export const CLUB_PROFILES_L2: Record<number, ClubProfile> = {
  ...
  9747: {
    ...
    directeurSportif: "Stéphane Le Mignan", entraineur: "Erwan Lannuzel",
  ...
  10174: {
    id: 10174, name: "Dijon FCO", shortName: "Dijon", league: "L2",
    surnom: "Le DFCO", fondation: 1998,
    ville: "Dijon", region: "Bourgogne-Franche-Comté", population: "155 090 hab.",
    couleurs: { primary: "#e10600", secondary: "#ffffff" },
    stade: { nom: "Stade Gaston-Gérard", capacite: "15 971", inauguration: 1934, photo: "Stade_Gaston-Gerard.jpg" },
    president: "Olivier Delcourt", presidentDepuis: 2009,
    actionnaire: "Olivier Delcourt (Groupe Delcourt)",
    directeurSportif: "Damien Roux", entraineur: "David Linarès",
    forme: "SASP", siege: "Stade Gaston-Gérard, 21000 Dijon",
    ca: "~12 M€", employes: "~40", dette: "—", billetterie: "~1 M€", droitsTv: "~5 M€",
    equipementier: "Kappa", sponsorMaillot: "Ville de Dijon",
    palmares: ["1× promu en L1 (2011, 2016, 2018)", "Champion National 2024"],
    sources: [{ label: "DNCG 2023", url: "https://www.lnfp.fr/dncg" }],
  },
  9807: {
    id: 9807, name: "FC Sochaux-Montbéliard", shortName: "Sochaux", league: "L2",
    surnom: "Les Lions", fondation: 1925,
    ville: "Montbéliard", region: "Bourgogne-Franche-Comté", population: "26 079 hab.",
    couleurs: { primary: "#ffcc00", secondary: "#004c96" },
    stade: { nom: "Stade Auguste-Bonal", capacite: "19 293", inauguration: 1953, photo: "Stade_Auguste-Bonal.jpg" },
    president: "Fan Zhiyi", presidentDepuis: 2021,
    actionnaire: "Invest Team (Chengdu Qianbao / Lifengda)",
    directeurSportif: "Eric Hély", entraineur: "Olivier Guégan",
    forme: "SASP", siege: "Stade Auguste-Bonal, 25200 Montbéliard",
    ca: "~18 M€", employes: "~50", dette: "—", billetterie: "~1,5 M€", droitsTv: "~6 M€",
    equipementier: "Puma", sponsorMaillot: "Peugeot",
    palmares: ["2× Ligue 1 (1935, 1938)", "2× Coupe de France (1937, 2007)", "Champion National 2024"],
    sources: [{ label: "DNCG 2023", url: "https://www.lnfp.fr/dncg" }],
  },
};
