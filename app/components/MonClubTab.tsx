...
const L1_CLUBS: Club[] = [
  ...
  { id:531,  name:"ES Troyes AC",         shortName:"Troyes",     color:"#1B47B0", color2:"#FFFFFF", stadium:"Stade de l'Aube",         city:"Troyes",             capacity:"21 877",
    crest:"https://crests.football-data.org/531.png" },
  { id:535,  name:"Le Mans FC",           shortName:"Le Mans",    color:"#E10600", color2:"#FFFFFF", stadium:"Stade Marie-Marvingt",    city:"Le Mans",            capacity:"25 064",
    crest:"https://crests.football-data.org/535.png" },
