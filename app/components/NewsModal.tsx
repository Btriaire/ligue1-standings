...
export default function NewsModal({ title, url, pubDate, onClose }: Props) {
  ...
  // Save scroll position & lock body scroll
  useEffect(() => {
  ...
  return (
    ...
    <div
      ...
      style={{ background: "rgba(4,7,13,0.88)", backdropFilter: "blur(6px)" }}
      onClick={e => { if (e.target === e.currentTarget) onClose(); }}
    >
      {/* Modal */}
      <div
        className="relative w-full sm:max-w-2xl mx-0 sm:mx-4 flex flex-col rounded-t-3xl sm:rounded-3xl overflow-hidden"
        style={{
          background: "#0d1421",
