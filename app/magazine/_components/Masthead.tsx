...
export default function Masthead({ issueNumber, formattedDate, tagline }: Props) {
  return (
    <header className="paper-grain" style={{ paddingTop: 24, paddingBottom: 16 }}>
      <div className="mag-gutter" style={{ maxWidth: 1180, margin: "0 auto", padding: 0 }}>
        {/* Top rail: small left meta, right meta. Wraps on narrow screens. */}
        ...
        <div style={{ paddingTop: 10, paddingBottom: 10, textAlign: "center" }}>
          ...
          <h1
            className="display"
            style={{ fontSize: "clamp(36px, 8.5vw, 96px)", letterSpacing: "-0.025em", margin: 0 }}
          >
            FOOT — Le Magazine
          </h1>
          <p
